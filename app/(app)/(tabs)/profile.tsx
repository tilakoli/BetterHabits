...
export default function ProfileScreen() {
  ...
  const renderAccountOption = (
    ...
    >
      <View
        style={[styles.optionIcon, { backgroundColor: `${colors.primary}15` }]}
      >
      ...
      >
        <View style={styles.profileHeader}>
          ...
          <View style={styles.streakContainer}>
            <StreakCounter currentStreak={user.streakCount} size="small" />
          </View>
        </View>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.sectionCard}>
            ...
            {renderAccountOption("history", "Challenge History", undefined, () =>
              router.push("/(app)/challengeHistory")
            )}
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.sectionCard}>
            ...
            {renderSettingToggle(
              ...
              settings.streakProtectionAlerts,
